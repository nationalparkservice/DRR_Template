...
A [template](https://github.com/nationalparkservice/DRR_Template/blob/master/DRR_to_docx.Rmd) for creating data release reports to be published in the DRR series. We have also
