...
```{r}
geographic_description <- "Landbird surveys in all NCCN parks"
```

Next, provide the file path and name of the data table that contains your monitoring site locations.

```{r}
site_table_path <- here::here("data", "final")  # You may not need to change this
site_table_name <- "Sites.csv"
```
