...
output:
  html_document:
    pandoc_args: [
    "--number-offset=0,0"
    ] #BJC 01/07/2021 Added pandoc arg becuase the title element was throwing an error
    df_print: kable
    fig_caption: true
    dev: svg
    highlight: haddock
...
knitr::opts_chunk$set(
   ...
   tidy = F #BJC 01/07/2021 Changed this from T to F, was throwing a string parsing error
   )
