...
dataPackage_fileNames<-c("my_data.csv",
                          "my_data2.csv")
...
This DRR describes the data package `r dataPackageTitle` which contains a metadata file and `r length(dataPackage_fileNames)` data files. These data were compiled by the National Park Service Biological Resources Division and are available at `r dataPackageDOI`. The files in the data package are:
