...
- **IMDQC.** Package that contains a wuite of quality control functions that may be of use when processing datasets. Installed from github using the following code:
...
Because data release reports and associated data pacages are cross-referential, report
...
It is possible to easily convert a report created in word into the template. To facilitate this, we have included a MSWord author template in the "common" folder within this project template. Conversion of tables and figures take a little work (and may not be fully 508-compliant), but the overall process should take no more than 15 minutes. Basic instructions are as follows:
...
3. Copy your text into the template after the startup conde chunk.
