...
```{r figure1, echo=FALSE, fig.align="center", fig.cap="**Figure 1.** Standard project directory structure for data release reports."}
...
````markdown
`r ''````{r figure1, echo=FALSE, fig.align="center", fig.cap="**Figure 2.** Example general workflow to include in the methods section."}
...
```{r figure2, echo=FALSE, fig.align="center", fig.cap="**Figure 2.** Example general workflow to include in the methods section."}
include_graphics("ProcessingWorkflow.png")
